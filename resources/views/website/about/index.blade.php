...
@section('header')
    ...
    <section id="cta" class="section section top_header">
        <img  class="w-100 h-100" src="https://www.creativefabrica.com/wp-content/uploads/2019/03/Monogram-ME-Logo-Design-by-Greenlines-Studios.jpg" alt="">
        ...
        <div class="wrapper">
            <div class="profile-card js-profile-card">
                <div class="profile-card__img">
                    <img src="https://www3.0zz0.com/2023/11/30/21/457645729.jpg" alt="profile card">
                </div>

                <div class="profile-card__cnt js-profile-cnt">
                    <div class="profile-card__name">Mina saad</div>
                    <div class="profile-card__txt">Front-end Developer from <strong>Egypt</strong></div>
                    ...
                    <div class="profile-card-social">
                        <a href="https://scarfaceps.online/" class="profile-card-social__item facebook" target="_blank">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item twitter" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item instagram" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item behance" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item github" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item codepen" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://scarfaceps.online/" class="profile-card-social__item link" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                    ...
                    <div class="profile-card-ctr">
                        <button class="profile-card__button button--blue js-message-btn"><a class="text-white"
                                href="#">Message</a></button>
                    </div>
                </div>
